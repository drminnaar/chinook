...
namespace Chinook.Operations.Api.Controllers
{
    ...
    public sealed class ErrorsController : ControllerBase
    {
        ...
        public IActionResult Error()
        {
            ...
            return error switch
            {
                ValidationFailuresException validationException => HandleValidationException(validationException),
        ...
        private IActionResult HandleValidationException(ValidationFailuresException validationException)
        {
            ...
            foreach (var failure in validationException.Failures)
                problemDetails.Errors.Add(failure.Key, failure.Value);
